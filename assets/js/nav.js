...
function navHome(){
    nav = document.getElementById('navHome').className;

        // window.alert(navCriar,navSeus);
    if(nav != 'ativo'){
         document.getElementById('navSeusOrcamentos').className = '';
         document.getElementById('navHome').className = 'ativo azul';
    }
}
function navSeusOrcamentos(){
  nav = document.getElementById('navSeusOrcamentos').className;

      // window.alert(navCriar,navSeus);
  if(nav != 'ativo'){
       document.getElementById('navSeusOrcamentos').className = 'ativo azul';
